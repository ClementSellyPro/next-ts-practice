  ...
  return (
    <div className="relative mx-16 w-full py-5">
        ...
        <div className='flex justify-between'>
            <PlanCard icon={arcadeIcon} name={'Arcade'} price={9} />
            <PlanCard icon={advancedIcon} name={'Advanced'} price={12} />
            <PlanCard icon={proIcon} name={'Pro'} price={15} />
        </div>

        {/* toggle section */}
        <div className='flex justify-center gap-5 py-3 bg-slate-100 rounded-xl mt-8 font-bold text-slate-500'>
            <p className={billingChoice === 'Monthly' ? 'text-indigo-700':''}>Monthly</p>
            ...
            <p className={billingChoice === 'Yearly' ? 'text-indigo-700':''}>Yearly</p>
        </div>
